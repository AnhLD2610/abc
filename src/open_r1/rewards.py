...
def get_reward_funcs(script_args) -> list[Callable]:
    ...
    from .custom_rewards import length_accuracy_reward, majority_voting_reward, entropy_exploration_reward
    ...
    REWARD_FUNCS_REGISTRY = {
        ...
        # Custom reward functions for efficient reasoning
        "length_accuracy": length_accuracy_reward,
        "majority_voting": majority_voting_reward,
        "entropy_exploration": update_wrapper(
            partial(
                entropy_exploration_reward,
                difficulty_threshold=getattr(script_args, "difficulty_threshold", 0.3),
            ),
            entropy_exploration_reward,
        ),
    }
